...
public class TaskList extends javax.swing.JFrame {
    ...
    //Function to close the current jFrame
    public void close(){
        WindowEvent winClosingEvent = new WindowEvent(this,WindowEvent.WINDOW_CLOSING);
        Toolkit.getDefaultToolkit().getSystemEventQueue().postEvent(winClosingEvent);
    }
    
    //Function to add a row to the table when new data is added
    public void addRow(){
    ...
    private void ViewTaskButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewTaskButtonActionPerformed
        //Opens the detailed task jFrame and adds in the name and due date automatically
        int index = TaskListTable.getSelectedRow();
        TableModel model = TaskListTable.getModel();
        String taskName = model.getValueAt(index, 1).toString();
        String dueDate = model.getValueAt(index, 2).toString();
        
        dt.setVisible(true);
        dt.pack();
        dt.NameTextField.setText(taskName);
        dt.DueDateFormatted.setText(dueDate);
